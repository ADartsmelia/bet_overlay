    ...
    def _encoder_cmd(self):
        ...
        if has_overlay:
            ...
            return [
                ...
                "-g", "50", "-bf", "0",
                "-c:a", "copy",
                "-metadata:s:a:0", "language=rus", "-metadata:s:a:0", "title=Russian",
                "-metadata:s:a:1", "language=eng", "-metadata:s:a:1", "title=English",
                "-metadata:s:a:2", "language=kat", "-metadata:s:a:2", "title=Georgian",
                "-metadata:s:a:3", "language=ukr", "-metadata:s:a:3", "title=Ukrainian",
                "-metadata:s:a:4", "language=kaz", "-metadata:s:a:4", "title=Kazakh",
                "-muxrate", "7000k",
                "-f", "mpegts", SRT_OUTPUT,
            ]
        else:
